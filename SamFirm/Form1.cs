namespace SamFirm
{
    ...
    public class Form1 : Form
    {
        ...
        {
            this.update_button.Invoke((Action)(() => this.update_button.Enabled = Enabled));
            this.download_button.Invoke((Action)(() => this.download_button.Enabled = Enabled));
            this.binary_checkbox.Invoke((Action)(() => this.binary_checkbox.Enabled = Enabled));
            this.model_textbox.Invoke((Action)(() => this.model_textbox.Enabled = Enabled));
            this.region_textbox.Invoke((Action)(() => this.region_textbox.Enabled = Enabled));
            this.checkbox_auto.Invoke((Action)(() => this.checkbox_auto.Enabled = Enabled));
            this.checkbox_manual.Invoke((Action)(() => this.checkbox_manual.Enabled = Enabled));
            this.checkbox_manual.Invoke((Action)(delegate {
            ...
            this.checkbox_autodecrypt.Invoke((Action)(() => this.checkbox_autodecrypt.Enabled = Enabled));
            this.checkbox_crc.Invoke((Action)(() => this.checkbox_crc.Enabled = Enabled));
        }
        ...
        private void decrypt_button_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                worker.DoWork += delegate (object o, DoWorkEventArgs _e) {
                    ...
                    this.decrypt_button.Invoke((Action)(() => this.decrypt_button.Enabled = false));
        ...
        public void SetProgressBar(int Progress)
        {
            ...
            this.progressBar.Invoke((Action)(delegate {
